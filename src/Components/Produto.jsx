...
function Produto() {
            ...
            <>
                <div className="loadingTextoImagem">
                    ...
                    <div className="d-flex justify-content-center .flex-column">
                        <div
                            className="spinner-borderPersonalizado"
                            role="status"
                        >
                            <img
                                className="imagemLogoCarregando"
                                src={logoSemLetra}
                                alt=""
                            />
                        </div>
    ...
    const MostrarProduto = () => {
        ...
        return (
            <>
                {filter.map((produto) => {
                      const Descricao = () =>{
                        // document.getElementsByClassName('descricaoCompleta').innerHTML = `${produto.description}`
                        return(
                          <>
                            {produto.description}
                          </>
                        ...
                        return (
                            ...
                            <>
                                <div className="col-md-6">
                                    <img
                                        src={
                                            produto.items[0].images[0].imageUrl
                                        }
                                ...
                                <div className="col-md-6 border my-5Personalizado">
                                    <div className="col-md-12 ms-2">
                                        <h1 className="display-6Personalizado nomeProduto">
                                            {produto.productName}
                                        </h1>
                                        <p className="leadPersonalizado">
                                            Marca: {produto.brand}
                                        </p>
                                        ...
                                        <button
                                            type="button"
                                            className="btn btn-primary botaoComprar"
                                        >
                                            <span className="iconeCart">
                                                <BsFillCartCheckFill />
                                            </span>{" "}
                                ...
                                <div>
                                    ...
                                    <p className="descricaoCompleta">
                                        <Markup content={produto.description} />
                                    </p>
                                </div>
                            </>
                        );
    ...
    return (
        <>
            <div>
                <button className="setaDeVoltarTela" onClick={voltarTela}>
                    <IoArrowBackSharp />
                </button>
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        >
                            <img
                                src={carina}
                                alt="Fale com a Carina"
                                className="imagemCarina"
                            />
                        </a>

                        <p className="mensagemFinal">
                            Desenvolvido por Xacarami para concorrer ao TechDay
                            do Carrefour + Digital Innovation One
                        </p>
                    </>
                )}
            </div>
